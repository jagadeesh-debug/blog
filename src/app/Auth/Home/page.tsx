    ...
    <div className="min-w-screen flex flex-col items-center justify-center gap-4 pt-16 mt-4 bg-black text-white">
      {loading ? (
        ...
        posts.map((post) => (
          <div
            key={post._id}
            className="w-1/2 p-4 flex justify-center items-start rounded-lg shadow-md flex-col shadow-md shadow-gray-400 text-violet-300 "
          >
            <p>{post.content}</p>
            <div className="w-full flex justify-between mt-3">
              <button className="flex items-center justify-center p-3 hover:shadow-md hover:shadow-violet-300 rounded-lg transition-colors">
                <i className="bx bx-upvote text-2xl text-2xl text-white"></i>
              </button>
              <button className="flex items-center justify-center p-3  hover:shadow-md hover:shadow-violet-300 rounded-lg transition-colors">
                <i className="bx bx-downvote text-2xl text-white "></i>
              </button>
              <button className="flex items-center justify-center p-3 hover:shadow-md hover:shadow-violet-300 rounded-lg transition-colors">
                <i className="bx bx-comment-detail text-2xl text-white "></i>
              </button>
              <button className="flex items-center justify-center p-3 hover:shadow-md hover:shadow-violet-300 rounded-lg transition-colors">
                <i className="bx bx-share text-2xl text-white"></i>
              </button>
              <button className="flex items-center justify-center p-3  hover:shadow-md hover:shadow-violet-300 rounded-lg transition-colors">
